Eat a Burger! is a burger logging app that utilizes MySQL, Node, Express, Handlebars and ORM. I used Node and MySQL to query and route the data and Handlebars to generate the HTML. 
